				...
				<table class="table">
					<thead>
						<tr>
							...
							<th>제목</th>
							<th style="text-align: center;">등록인</th>
							<th style="text-align: center;">삭제</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="obj" items="${pagelist }" varStatus="status">
							<tr>
								<td style="text-align: center;">${obj.NUM }</td>
								<td><a href="/informationdetail?num=${obj.NUM }">${obj.TITLE }</a>
								</td>
					...
					<tbody>
						<c:forEach var="obj" items="${pagelist }" varStatus="status">
							<tr>
								...
								<td><a id="infodetail"
									href="/informationdetail?num=${obj.NUM }" type="button"
									style="cursor: hand; color: black;">${obj.TITLE }</a></td>
								<td style="text-align: center;">"${obj.ID }"</td>
							</tr>

			...
			<div class="well">
				...
				<div class="form-group">
					<label for="bk_address" style="float: left; width: 115">등록인
						이름:</label> <input type="text" class="form-control" id="bk_regname" value="${list.BK_REGNAME }"
					required="required"	name="bk_regname" style="float: left; width: 250" /> <b
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="bk_password" required="required"
				...
				<div class="form-group">
					<label for="bk_contact" style="float: left; width: 115">개인
						...
						<option>${list.bk_contact0 }</option>
						<option>010</option>
						<option>011</option>
						<option>016</option>
						<option>017</option>
						<option>018</option>
						<option>019</option>
					</select> <input type="text" class="form-control " id="bk_contact" value="${list.bk_contact1 }" required="required"
						name="bk_contact" style="float: left; width: 85" /> <input value="${list.bk_contact2 }" required="required"
				...
				<div class="form-group">
					<label for="bk_address" style="float: left; width: 115">부동산
						...
						name="bk_officename" style="float: left; width: 250" value="${list.BK_OFFICENAME }"  required="required" disabled="disabled"/>
				</div>
<br/>	
				...
				<div class="form-group">
					<label for="bk_email" style="float: left; width: 115">부동산
						...
						class="form-control" id="bk_email" placeholder="Enter email" value="${list.BK_EMAIL }" required="required"
				...
				<div class="form-group">
					<label for="bk_contact" style="float: left; width: 115">사무소
						...
						<option>063</option>
						<option>064</option>
					</select> <input type="text" class="form-control" id="bk_agentnum" value="${list.bk_num1 }" required="required"
						name="bk_agentnum" style="float: left; width: 85" /> <input
						type="text" class="form-control" id="bk_agentnum" value="${list.bk_num2 }" required="required"
				...
				<div class="form-group">
					...
					<input type="text" class="form-control postcodify_address" id="bk_address" name="bk_address" 
					required="required" readonly="readonly" style="float: left; width: 200"/>
					...
					required="required" id="bk_address" name="bk_address" style="float: left; width: 250" />
